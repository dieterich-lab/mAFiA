...
polyA_file = os.path.join(polyA_dir, f"{ds}_{cond}_polyA.txt")
...
df_polyA_sel.to_csv(os.path.join(polyA_dir, f'polyA_reads_annotated_{ds}_{cond}.tsv'), sep='\t', index=False)
