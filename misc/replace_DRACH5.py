...
orig_file = os.path.join(prj_dir, f'DRACH/{ds}/chr{chr}/mAFiA.sites.bed')
replace_file = os.path.join(prj_dir, f'DRACH5_retrain/{ds}/chr{chr}/mAFiA.sites.bed')
out_dir = os.path.join(prj_dir, f'DRACH_replaced/{ds}/chr{chr}')
