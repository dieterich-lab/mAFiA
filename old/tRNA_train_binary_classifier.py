...
for ind, mod_site in df_mod_sel.iterrows():
    ...
    wt_site_motif_features = get_nucleotides_aligned_to_target_pos(wt_bam, contig, start, wt_predStr_features)
    ivt_site_motif_features = get_nucleotides_aligned_to_target_pos(ivt_bam, contig, start, ivt_predStr_features, enforce_motif=ref_motif)
