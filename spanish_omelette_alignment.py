...
out_hist_path = os.path.join(os.path.dirname(args.sam_file), 'hist_spomlette_mapping_scores_q{}.png'.format(args.thresh_mapq))
...
plt.title('Pass rate at Q$\geq${}\n{}/{} = {}%'.format(args.thresh_mapq, num_pass, len(queries), pass_rate), fontsize=15)
