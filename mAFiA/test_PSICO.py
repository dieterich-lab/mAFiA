...
def main():
    ...
    site_writer = SiteWriter(out_path=os.path.join(args.out_dir, 'psUco.sites.bed'))
    bam_writer = BAMWriter(in_bam_path=args.bam_file, out_bam_path=os.path.join(args.out_dir, 'psUco.reads.bam'))
