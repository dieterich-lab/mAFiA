...
BAM=${PRJ_DIR}/oligo/${TEST_DATASET}/renata.minimap.bam
FAST5_DIR=${PRJ_DIR}/oligo/${TEST_DATASET}/fast5
LIG_REF=${PRJ_DIR}/oligo/${TEST_DATASET}/ligation_ref.fasta
...
OUTFILE=${PRJ_DIR}/results/res_train_${TRAIN_DATASET}_test_${TEST_DATASET}_minimap.tsv
########################################################################################################################
