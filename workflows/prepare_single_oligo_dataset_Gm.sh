...
PRJ_DIR=/beegfs/prj/TRR319_RMaP/Project_BaseCalling/Adrian/Gm
...
#### merge ligation ref ###
#for RUN in mix37_mix43 mix38_mix44 mix39_mix45 mix40_mix46 mix41_mix47 mix42_mix48
#do
#  MERGE_REF_INPUTS=""
#  for MOD in unm mod
#  do
#    MERGE_REF_INPUTS+="${PRJ_DIR}/oligo/${ORIG}_${RUN}_${MOD}/ligation_ref.fasta "
#  done
#  mkdir ${PRJ_DIR}/oligo/ligation_ref
#  MERGE_REF_OUTPUT="${PRJ_DIR}/oligo/ligation_ref/ligation_ref_${RUN}.fasta"
