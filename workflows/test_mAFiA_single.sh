...
#SBATCH --mem=160GB
#SBATCH --verbose
#SBATCH --job-name=GLORI_IVT_chr1
#SBATCH --output=/home/achan/slurm/GLORI_IVT_chr1.out
...
bam=/prj/TRR319_RMaP/Project_BaseCalling/Adrian/m6A/HEK293/0_WT_100_IVT/filtered_q50.bam
...
output=/prj/TRR319_RMaP/Project_BaseCalling/Adrian/m6A/GLORI/${ds}/chr${chr}
