...
plt.suptitile('m6Anet on HEK293\nn_reads$\\geq${}, p_val$\\leq${}'.format(thresh_n_reads, thresh_pval))
plt.savefig(os.path.join(out_dir, 'all_ds_nreads{}_pval{}.png'.format(thresh_n_reads, thresh_pval)), bbox_inches='tight')